...
public class ApkYuklemeStepDefinitions {
    @Given("Kullanici gerekli adimlari atarak {string} yukler")
    public void kullaniciGerekliAdimlariAtarakYukler(String apk) throws MalformedURLException {
...
//App githuba yuklenmedigi icin sildim
        /*
        Hepsi burada nin APK siydi
         */
